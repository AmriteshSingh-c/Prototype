              ...
              <div class="row">
                <form method="post" action="addpost.php">
                  <div class="col-md-12 latest-job ">
                    ...
                    <div class="form-group">
                      <input type="number" class="form-control  input-lg" id="ctc" autocomplete="off" name="ctc"
                        placeholder="CTC" required="">
                    </div>
                    <div class="form-group">
                      <input type="number" class="form-control  input-lg" id="ssc_eligibility" name="ssc_eligibility"
                        placeholder="SSC Eligibility Criteria" required="">
                    </div>
                    <div class="form-group">
                      <input type="number" class="form-control  input-lg" id="hsc_eligibility" name="hsc_eligibility"
                        placeholder="HSC Eligibility Criteria" required="">
                    </div>
                    <div class="form-group">
                      <input type="number" class="form-control  input-lg" id="ug_eligibility" name="ug_eligibility"
                        placeholder="UG Eligibility Criteria" required="">
                    </div>
