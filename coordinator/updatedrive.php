                            ...
                            <div class="box box-solid">
                                ...
                                <div class="box-body no-padding">
                                    <ul class="nav nav-pills nav-stacked">
                                        ...
                                        <li><a href="create-job-post.php"><i class="fa fa-file-o"></i> Post Drive</a>
                                        </li>
                                        <li class="active"><a href="my-job-post.php"><i class="fa fa-file-o"></i>
                                                Current Drives</a></li>
                                        <li><a href="job-applications.php"><i class="fa fa-file-o"></i> Drive
                                                Applications</a></li>
                                        <li><a href="mailbox.php"><i class="fa fa-envelope"></i> Mailbox</a></li>
                                        <li><a href="settings.php"><i class="fa fa-gear"></i> Settings</a></li>
                                        <li><a href="resume-database.php"><i class="fa fa-user"></i> Resume Database</a>
                                        </li>
                                    ...
                                    if ($result->num_rows > 0) {
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            <div class="col-md-6 latest-job ">
                                                ...
                                                <div class="form-group">
                                                    <label>Role</label>
                                                    <input type="text" class="form-control input-lg" name="role" id="role"
                                                ...
                                                <div class="form-group">
                                                    <button type="submit" name="submit" id="submit"
                                                        class="btn btn-flat btn-success">Update Profile</button>
                                                </div>
                                            </div>
                                            <div class="col-md-6 latest-job ">
                                                <div class="form-group">
                                                    <label for="contactno">Eligibility</label>
                                                    <input type="text" class="form-control input-lg" id="Eligibility"
                                                        name="Eligibility" placeholder="Eligibility"
                                                        value="<?php echo $row['maximumsalary']; ?>">
                                                </div>
                                                <div class="form-group">
                                                    <label for="city">CTC</label>
                                                    <input type="text" class="form-control input-lg" id="CTC" name="CTC"
                                                        value="<?php echo $row['minimumsalary']; ?>" placeholder="CTC">
                                                </div>
                                                <div class="form-group">
