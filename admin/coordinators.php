              ...
              <div class="box box-solid">
                ...
                <div class="box-body no-padding">
                  <ul class="nav nav-pills nav-stacked">
                    ...
                    <li class="active"><a href="coordinators.php"><i class="fa fa-arrow-circle-o-right"></i> Co -
                        Ordinators</a></li>
                            ...
                            <tr>
                              ...
                              <td>
                                ...
                                if ($row['active'] == '1') {
                                  ...
                                  ?>
                                    <a href="reject-coordinator.php?id=<?php echo $row['id_coordinator']; ?>">Reject</a> <a
                                      href="approve-coordinator.php?id=<?php echo $row['id_coordinator']; ?>">Approve</a>
                                  <?php
                              ...
                              <td><a href="delete-coordinator.php?id=<?php echo $row['id_coordinator']; ?>">Delete</a></td>
                            </tr>
                            <?php
                          }
                        }
