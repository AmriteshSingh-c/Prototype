...
<body class="">
  ...
  <!-- </header> -->
  <div style="">
    <div class="login-box hello" style="display:flex;flex-direction:column;justify-content:center;margin-top:200px;">
      <div class="login-logo " style="">

        <a href="index.php" style="color:black"><b>Placement Portal</b></a>
      </div>
      <!-- /.login-logo -->
      <div class="login-box-body bg-blue-300 text-black ">
        <p class="login-box-msg text-3xl text-black">Student Login</p>
          ...
          <div class="row ">
            ...
            <div class="col-xs-4">
              <button type="submit"
                ...
                style="background-color:#3db166;">Sign
                In</button>
            </div>
            <!-- /.col -->
          </div>
        ...
        if (isset($_SESSION['registerCompleted'])) {
          ?>
          <div>
            <p id="successMessage" class="text-center">You Have Registered Successfully! Your Account Approval Is Pending
              By
              Placement-Officer</p>
          </div>
          <?php
      ...
      <a class="text-xl text-blue" href="register-candidates.php">Create new account</a>
      <!-- /.login-box-body -->
    </div>
    <div>
      <!-- /.login-box -->
      ...
      <!-- footer starts -->
      <div style="position:absolute;bottom:0px;width:100%;text-align:center;align-items:center">
        <?php
