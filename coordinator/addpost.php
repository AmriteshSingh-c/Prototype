...
if (isset($_POST)) {
	...
	$stmt = $conn->prepare("INSERT INTO job_post(id_coordinator, companyname, description, ctc, ssc_eligibility,hsc_eligibility,ug_eligibility) VALUES (?,?, ?, ?, ?, ?, ?)");

	$stmt->bind_param("issssss", $_SESSION['id_coordinator'], $companyname, $description, $ctc, $ssc_eligibility, $hsc_eligibility, $ug_eligibility);

	$companyname = mysqli_real_escape_string($conn, $_POST['companyname']);
	$description = mysqli_real_escape_string($conn, $_POST['description']);
	$ctc = mysqli_real_escape_string($conn, $_POST['ctc']);

	$ssc_eligibility = mysqli_real_escape_string($conn, $_POST['ssc_eligibility']);
	$hsc_eligibility = mysqli_real_escape_string($conn, $_POST['hsc_eligibility']);
	$ug_eligibility = mysqli_real_escape_string($conn, $_POST['ug_eligibility']);
