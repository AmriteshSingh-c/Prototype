...
$jobpostid = $url[-1];
$sql = "SELECT * FROM apply_job_post WHERE id_jobpost='$jobpostid'";
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <div>
                        ...
                        if ($row1['resume'] != "") {
                          echo '<a href="../uploads/resume/' . $row1['resume'] . '" class="btn btn-info" download="Resume">Download Resume</a>';
                        }
                        echo '<br>';
                        echo '<br>';
                        echo '<br>';
                        ...
                        <div class="row">
                          <div class="col-md-3 pull-right">
                            <a href="reject.php?id=<?php echo $row1['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>"
                              class="btn btn-danger">Not Placed</a>
                          </div>
                          <div class="col-md-3 pull-right">
                            <a href="under-review.php?id=<?php echo $row1['id_user']; ?>&id_jobpost=<?php echo $_GET['id_jobpost']; ?>"
