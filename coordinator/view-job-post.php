          ...
          <div class="row">
            ...
            <div class="col-md-9 bg-white padding-2">
              <div class="row margin-top-20">
                <div class="col-md-12">
                  <?php
                  $sql = "SELECT * FROM job_post WHERE id_coordinator='$_SESSION[id_coordinator]' AND id_jobpost='$_GET[id]'";
                  ...
                  if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <hr>
                      <div>
                        </span><span class="margin-right-10"> <i class="fa fa-money text-green"> CTC:</i>
                          <?php echo "Rs " . $row['ctc'] . "    "; ?>
                        ...
                        </span><span class="margin-right-10"><i class="fa fa-location-calendar text-green"> S
                            S C Eligibility:
                          </i>
                          <?php echo $row['ssc_eligibility'] . "%"; ?>
                        </span>
                        <span class="margin-right-10"><i class="fa fa-location-calendar text-green">
                            HSC Eligibility:
                          </i>
                          <?php echo $row['hsc_eligibility'] . "%"; ?>
                        </span>
                        <span class="margin-right-10">
                          <i class="fa fa-location-calendar text-green"> UG Eligibility:
                          </i>
                      ...
                      <div class="pull-right">
                        <a style="margin-left:2px" href="updatedrive.php?id=<?php echo $row['id_jobpost']; ?>"
                          class="btn btn-default btn-lg btn-flat margin-top-20"><i class="fa fa-arrow-circle-lef" "></i> Update Drive</a>
                                                  </div>
                                              <?php
                    }
                  }
