        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-md-9 bg-white padding-2">
              ...
              $sql = "SELECT * FROM job_post INNER JOIN apply_job_post ON job_post.id_jobpost=apply_job_post.id_jobpost WHERE apply_job_post.id_user='$_SESSION[id_coordinator]'";
              // $sql = "SELECT * FROM job_post WHERE id_coordinator='$_SESSION[id_coordinator]'";
                ...
                while ($row = $result->fetch_assoc()) {
                  ...
                  <div class="attachment-block clearfix padding-2">
                    <h4 class="attachment-heading"><a
                        href="user-application.php?id_jobpost=<?php echo $row['id_jobpost']; ?>"><?php echo $row['companyname']; ?></a></h4>
                    <div class="attachment-text padding-2">
                      ...
                      if ($row['active'] == 1) {
                        echo '<div class="pull-right"><strong class="text-orange">Ongoing</strong></div>';
                      } else if ($row['active'] == 0) {
                        echo '<div class="pull-right"><strong class="text-red">Completed</strong></div>';
                      } else if ($row['active'] == 2) {
                        echo '<div class="pull-right"><strong class="text-green">On hold</strong></div> ';
                      }
                      ?>
