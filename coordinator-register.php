...
<body class="hold-transition skin-green sidebar-mini">
      ...
      <section class="content-header">
        <div class="container">
          <div class="row latest-job margin-top-50 margin-bottom-20 bg-white">
            <h3 class="text-center margin-bottom-20">Coordinator Profile</h3>
            <form method="post" id="registerCoordinators" action="addcoordinator.php" enctype="multipart/form-data">
              <div class="col-md-6 latest-job ">
                ...
                <div class="form-group">
                  <input class="form-control input-lg" type="password" name="cpassword" placeholder="Confirm Password"
                    required>
                </div>
  ...
  <script>
    $("#registerCoordinators").on("submit", function (e) {
      e.preventDefault();
